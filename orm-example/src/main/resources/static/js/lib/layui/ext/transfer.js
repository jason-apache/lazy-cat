// 使用扩展组件 https://github.com/9499574/layui-transfer
layui.define('table',function (exports) {
    ...
    Class.prototype.createHTMLDocument = function () {
        let that = this
            ...
            ,index= that.index;
        //创建页面元素
        let html = `<div class="layui-container">
                    <div class="layui-row">
                      <div class="`+MD5+`">
    ...
    function datas (type) {
        ...
        if(d1.length > 0 && type===0){
            ...
            if (typeof transfer.options.onchange === 'function') {
                transfer.options.onchange(type, records)
            }
