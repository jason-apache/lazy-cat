 ...
 */
public class LikeConditionExpressionSqlString extends AbstractSqlString implements ConditionExpressionSqlString, SqlString {

    protected final Class<? extends Like> type;
    private final FunctionSqlString function;

    public LikeConditionExpressionSqlString(Class<? extends Like> type, FunctionSqlString function) {
        super(JdbcOperationSupport.getDialect().getKeywordDictionary().like());
        this.type = type;
